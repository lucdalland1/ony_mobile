...
class JustificatifController extends GetxController {
  ...
  Future<void> pickIdFile() async {
    try {
      ...
      SnackBarService.error('Impossible de sélectionner le fichier ');
    } finally {
      isLoading(false);
    }
  }
  ...
  void submitForm() {
    ...
    SnackBarService.warning( 'Formulaire soumis avec succès');
