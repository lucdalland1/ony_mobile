...
class RechargePhone extends StatefulWidget {
  const RechargePhone({super.key});

  @override
  State<RechargePhone> createState() => _RechargePhoneState();
}

class _RechargePhoneState extends State<RechargePhone> {
              ...
              child: Column(
                children: [
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      labelText: "Numéro de téléphone à recharger".tr,
                      fillColor: AppColorModel.WhiteColor,
                      hintText: "Numéro de téléphone à recharger".tr,
                      hintStyle: TextStyle(color: AppColorModel.Grey),
                    ),
