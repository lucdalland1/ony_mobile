...
class CommanderCarte2 extends StatefulWidget {
  const CommanderCarte2({super.key});

  @override
  State<CommanderCarte2> createState() => _CarteVirtuelle2State();
}

class _CarteVirtuelle2State extends State<CommanderCarte2> {
              ...
              child: Column(
                children: [
                  ...
                  Text(
                      ...
                      Text("et sans accroc. Commander votre carte dès"),
